...
test("marketplace accuracy is required, bounded at runtime, and boundary uncertainty is excluded", () => {
  ...
  assert.equal(serviceAreaForCoordinates(24.092714276043068, 52.453150217708412), UAE_SERVICE_AREA);
});
...
test("Driver schema declares sparse 2dsphere location index", () => {
  ...
  assert.equal(discoveryRoom("uae", " Small Pickup "), "discovery:uae:small_pickup");
});
