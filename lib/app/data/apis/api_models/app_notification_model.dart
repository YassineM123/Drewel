class AppNotificationModel {
  ...
  static String _titleFor(String? type) => switch (type) {
        ...
        'POINTS_LOW_BALANCE' => 'Balance getting low',
        'POINTS_INSUFFICIENT_BALANCE' => 'Not enough balance',
        'PURCHASED_POINTS_CREDITED' => 'Balance purchased',
        'POINTS_CREDITED' => 'Balance credited',
        'POINTS_ADJUSTED' => 'Balance deducted',
        'WELCOME_POINTS_RECEIVED' => 'Welcome bonus',
        'OFFER_POINTS_RELEASED' => 'Balance released',
        'RIDE_POINTS_CHARGED' => 'Balance charged',
