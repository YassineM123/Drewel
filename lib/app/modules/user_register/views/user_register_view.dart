          ...
          body: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: MediaQuery.of(context).size.height - 140.px,
                padding:
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color: controller.cityIndex.value ==
                                                  index
                                              ? primaryColor
                                              : Colors.black.withOpacity(0.2))),
                                  child: Text(
                                    controller.cityList[index],
                                    style: controller.cityIndex.value == index
                              ...
                              children: [
                                Container(
                                  ...
                                  child: CommonWidgets.appIcons(
                                      assetName: controller.transportList[index]
                                              ['image'] ??
                                          '',
                                      height: 32.px,
                                      width: 50.px,
                                  ...
                                  child: FittedBox(
                                    ...
                                    child: Text(
                                      controller.transportList[index]['name'] ??
                                          '',
                                      style: controller.transportIndex.value ==
                                              index
