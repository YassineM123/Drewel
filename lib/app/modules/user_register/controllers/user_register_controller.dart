...
class UserRegisterController extends GetxController {
  ...
  Future<void> callingGetBannerListApi() async {
    try {
      ...
      await ApiMethods.getBannerApi();
      if (bannerModel != null && bannerModel.success != null &&
          bannerModel.success! && bannerModel.banners!=null ) {
  ...
  void clickOnFindNowButton(){
    Map<String,String> data={
      ...
      ApiKeyConstants.city:LocalData().cityList[cityIndex.value].replaceAll('\n', '').trim(),
      ApiKeyConstants.vehicleType:LocalData().transportList[transportIndex.value]['name'].toString().trim(),
    };
