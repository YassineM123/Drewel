...
//  static LoginModel? loginModel;
  ...
  List<Map<String, dynamic>> cityLatLongList = [
    ...
    {'index': 1, 'lat': 25.2048, 'lon': 55.2708, 'city': 'Dubai'},
    {'index': 2, 'lat': 25.3562, 'lon': 55.4272, 'city': 'Sharjah'},
    {'index': 3, 'lat': 25.4052, 'lon': 55.5136, 'city': 'Ajman'},
    {'index': 4, 'lat': 24.2232, 'lon': 55.7229, 'city': 'Al Ain'},
  ...
  List<Map<String, String>> transportList = [
    ...
    {'image': IconConstants.icLargePickUp, 'name': 'Large Pickup'},
    {'image': IconConstants.icMoving, 'name': 'Moving'},
    {'image': IconConstants.icGasTruck, 'name': 'Gaz Delivery'},
