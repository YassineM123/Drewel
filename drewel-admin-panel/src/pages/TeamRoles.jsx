...
const FALLBACK_PERMISSIONS = [
  ...
  { label: "Cancel or Intervene in Rides",  owner: true,  finance_admin: true,  admin: true  },
  { label: "Resolve Disputes",              owner: true,  finance_admin: true,  admin: true  },
  { label: "View Driver Profiles",          owner: true,  finance_admin: true,  admin: true  },
  { label: "Restrict / Unrestrict Drivers", owner: true,  finance_admin: true,  admin: true  },
  { label: "Approve Verification Requests", owner: true,  finance_admin: true,  admin: true  },
  ...
  { label: "Read In-App Chat",              owner: true,  finance_admin: true,  admin: true  },
  { label: "Manage Sponsor Banners",        owner: true,  finance_admin: true,  admin: true  },
