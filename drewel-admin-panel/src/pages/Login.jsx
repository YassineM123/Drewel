      ...
      <div className="hidden lg:flex lg:w-[54%] bg-[#1A0608] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/50 text-base leading-relaxed max-w-[360px]">
            Real-time visibility across your driver network, verification workflows, and passenger activity&mdash;all from a single secure console.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400"><Mail size={15} /></span>
                <input
                  type="email"
                  value={email}
